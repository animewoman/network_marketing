<template>
  <div>
    ...
    <div class="col bg-red justify-center" style="height: 600px">
      ...
      <div class="row justify-center">
        <div>
          ...
          <div class="row justify-center">
            <q-badge class="q-mt-md q-mb-sm" color="positive"> Этап {{ stageNumber }} </q-badge>
          </div>
        </div>
      </div>

      <div v-if="currentStage && currentStage.length">
        <div class="row justify-center" style="height: 150px">
          <q-card v-if="currentStage[0]" class="col-2 q-ma-sm bg-green-5" style="border-radius: 50%">
            <q-item
        ...
        <div class="row q-pt-sm justify-evenly" style="height: 150px">
          <q-card v-if="currentStage[1]" class="col-2 q-ma-sm bg-green-5" style="border-radius: 50%">
            <q-item
              class="row justify-center q-px-md"
              clickable
          ...
          <q-card v-if="currentStage[2]" class="col-2 q-ma-sm bg-green-5" style="border-radius: 50%">
            <q-item
              class="row justify-center q-px-md"
              clickable
        ...
        <div class="row q-pt-sm justify-evenly" style="height: 150px">
          <q-card v-if="currentStage[3]" class="col-2 q-ma-sm bg-green-5" style="border-radius: 50%">
            <q-item
              class="row justify-center q-px-md"
              clickable
          ...
          <q-card v-if="currentStage[4]" class="col-2 q-ma-sm bg-green-5" style="border-radius: 50%">
            <q-item
              class="row justify-center q-px-md"
              clickable
          ...
          <q-card v-if="currentStage[5]" class="col-2 q-ma-sm bg-green-5" style="border-radius: 50%">
            <q-item
              class="row justify-center q-px-md"
              clickable
          ...
          <q-card v-if="currentStage[6]" class="col-2 q-ma-sm bg-green-5" style="border-radius: 50%">
            <q-item
              class="row justify-center q-px-md"
              clickable
